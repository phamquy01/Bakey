                ...
                <div class="row product-row ">
                    <div class="accordion-item p-3 rounded-10 d-lg-none">
                        <h2 class="accordion-header" id="flush-headingMenu">
                            <button class="accordion-button px-3 fw-4 bg-color-10 shadow-none color-1 collapsed"
                        ...
                        <div id="flush-collapseMenu" class="accordion-collapse collapse px-5"
                            aria-labelledby="flush-headingMenu" data-bs-parent="#accordionFlushMenu">
                                ...
                                @foreach ($categories as $item)
                                    <div class="list-category__item bg-color-5">
                                        <div
                                            ...
                                            <a class="text-decoration-none text-reset py-2 fs-6 fw-6 flex-grow-1"
                            ...
                            <div class="p-1">
                                ...
                                <div class="list-category__content px-3 accordion accordion-flush mt-3">
                                    <div
                                        class="list-category__item-name position-relative d-flex align-items-center justify-content-between ">
                                        <a class="text-decoration-none text-reset py-2 fs-6 fw-6 flex-grow-1"
                                            href="/products">Tất cả sản phẩm</a>
                                    </div>
                                    @foreach ($categories as $item)
                                        <div class="list-category__item accordion bg-color-5">
                                            <div
                                                class="list-category__item-name flex-wrap position-relative d-flex align-items-center justify-content-between">
                                                <a class="text-decoration-none text-reset py-2 fs-6 fw-6 flex-grow-1"
                                                    href="/category/{{ $item->slug }}">{{ $item->name }}</a>
                                                @if (count($item->children) > 0)
                                                    <div class="py-2 ps-2" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    @include('layouts.cat-item-child', [
                                                        'listCategory' => $item->children,
                                                        'id' => $item->id,
                                                    ])
                                                @endif
                                            </div>
                    ...
                    <div class="product-row--right col-lg-9">
                        <div
                            class="sort-bar py-12 d-flex justify-content-start align-items-center bg-color-5 rounded-10 p-3">
                            <form action="" method="GET" class="d-flex flex-column flex-md-row flex-grow-1 mb-0">
                                ...
                                <div class="sort-bar-item me-0 d-flex align-items-center">
                                    ...
                                    <select name="limit" class="border-0 bg-transparent product-display p-0 fs-7"
                                        ...
                                        <option value="24" {{ request()->limit == '24' ? 'selected' : '' }}>24
                                        </option>
                                        <option value="30" {{ request()->limit == '30' ? 'selected' : '' }}>30
                                        </option>
                                    </select>
                                </div>
                            </form>
                            ...
                            @foreach ($products as $item)
                                <div class="product-item col-lg-4 col-6 mt-4">
                                    <a href="/product/{{ $item->slug }}" class="text-decoration-none h-auto">
                                        <div
                                            class="product-item__inner bg-color-5 rounded-6 position-relative overflow-hidden box-product h-100 d-flex flex-column">
                                            <div class="box-product__image ratio ratio-1x1">
                                                <img loading="lazy" class="w-100 h-100 object-fit-cover"
                                                    src="/uploads/products.webp" alt="iPhone 15 128GB">
                                            </div>
                                            @if ($item->price > $item->new_price && $item->price > 0 && $item->new_price > 0)
                                                <div
                                                    class="box--sale--off bg-color-13 color-14 rounded-2 d-flex align-items-center justify-content-center flex-column position-absolute p-2 m-2">
                                                    <span class="fs-7">
